...
def seed_database():
    ...
    cat_corn = AnimalFood.create(cat.id, cat_corn.id, "true")
    cat_peanuts = AnimalFood.create(cat.id, cat_peanuts.id, "true")
    cat_apple_seeds = AnimalFood.create(cat.id, cat_apple_seeds.id, "true")
    cat_bread = AnimalFood.create(cat.id, cat_bread.id, "true")
    cat_banana = AnimalFood.create(cat.id, cat_banana.id, "true")
    cat_watermelon = AnimalFood.create(cat.id, cat_watermelon.id, "true")
    cat_carrot = AnimalFood.create(cat.id, cat_carrot.id, "true")
